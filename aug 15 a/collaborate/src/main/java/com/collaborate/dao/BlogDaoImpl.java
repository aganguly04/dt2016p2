...
public class BlogDaoImpl implements BlogDao {
	...
	public List<Blog> getComments(int blogId) {
		Session s = getSession();
		String hql = "from Blog where blogChildId = :id and approved !=0";
	...
	public List<Blog> showApprovedBlogs() {
		// TODO Auto-generated method stub
		Session s = getSession();
		Query q=s.createQuery("from Blog where approved != 0  and blogChildId=0");
		List<Blog> blogs=q.list();
		return blogs;
	}
	...
	public List<Blog> showRecentBlogs(String p) {
		// TODO Auto-generated method stub
		String un=p;
		String hql="from Blog where owner=:un and approved !=0 and blogChildId=0";
		Session s=getSession();
		Query query=s.createQuery(hql);
