				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<span class="text-muted">Phone: </span>${profile.users.userPhone}<br> <br>
							<span class="text-muted">Address: </span>${profile.users.userAddress}<br> <br>
							<span class="text-muted">Location: </span>${profile.users.userLoction}<br> <br>
...
======================================== -->
						...
						<c:url 	value="action?action=unfriend&user=${profile.users.userName}&myself=${mySelf}" 	var="unfriend"/>
								<c:url 		value="action?action=accept&user=${profile.users.userName}&myself=${mySelf}" var="accept" />
								<c:url 		value="action?action=cancel&user=${profile.users.userName}&myself=${mySelf}" var="cancel" />
								<c:url value="action?action=send&user=${profile.users.userName}&myself=${mySelf}" var="send" />
...
<ul>
  <c:forEach items="${blogs}" var="b">
   <li><a href="showcomments?blogId=${b.blogId}">${b.title}</a></li>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<hr>
								<a href="showfriends">	<button class="btn btn-default pull-left">
										<i class="glyphicon glyphicon-pencil"></i> Show Friends
									</button></a>
								</div>
