...
<div ng-app="myAppf">
   <div class="panel panel-default">
              ...
              <div class="tablecontainer table table-bordered table-hover table-striped table-condensed" style="border: 2px solid; width: 70%; text-align:left ; background: gray;" ng-controller="BlogController as ctrl">
