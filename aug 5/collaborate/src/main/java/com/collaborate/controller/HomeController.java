...
///////     Friend Request Related Actions
	...
	public ModelAndView action(@RequestParam("action") String action ,@RequestParam("user") String user ,@RequestParam("myself") String myself,Model model) {
...
//   add forum
	...
	public String addNewPost(@ModelAttribute("post") Post post, BindingResult result, ModelMap model,Map<String, Object> map) {
