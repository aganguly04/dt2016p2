...
public class HomeController {
	...
	public String savecomment(@ModelAttribute("commentDto")CommentDto commentDto, 
		      BindingResult result, ModelMap model,@RequestParam("id") Integer categoryId,@RequestParam("bid") Integer blogId , Map<String, Object> map)
	 {
