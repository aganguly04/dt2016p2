...
public class HomeController {
	...
	@RequestMapping(value = "/approveforumposts", method = RequestMethod.GET)
	public ModelAndView approveforumposts() {

		return new ModelAndView("approveforumposts");
	}
	...
	public ModelAndView showUsers(Principal p) throws IOException {
        String un=p.getName();
		ModelAndView mav = new ModelAndView("showusers");

		// ProductServiceImpl productService=new ProductServiceImpl();
		ArrayList<Users> u = (ArrayList<Users>) usersService.getAllUsers(un);
