...
<div style="color: teal;font-size: 30px">Add Comment</div>
<br><br>
...
<td><form:input path="blog.name" /></td>
</tr>
<tr>
<td>
        <form:label path="blog.title">Title</form:label></td>
<td><form:input path="blog.title" /></td>
</tr>
<tr>
<td>
...
<tr>
<td><input type="submit" value="Save Blog" /></td><td></td>
</tr>
</table>
