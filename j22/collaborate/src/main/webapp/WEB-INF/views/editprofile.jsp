...
<form:form id="editUser"  modelAttribute="user" commandName="user" method="post" action="${editprofile}" enctype="multipart/form-data">
...
<input type="submit"  id="btnSubmit"  value="Sdit"  name="action" />
